  ...
  tabsetPanel(
    ...
    tabPanel(
      ...
      div(
        ...
        img(
          src = "seattle-wa_416x416.png",
          alt = "Photo",
          width = "250px",
          height = "250px",
          style = "position: absolute; top: 10px; left: 1100px;"
        )
      ),
    ...
    tabPanel(
      ...
      sidebarLayout(
        sidebarPanel(
          p("This figure displays the total amount of committed and reported crimes over the entire dataset. It depicts how the number of committed and reported crimes fluctuates throughout the months of the year, as well as serving as a comparison between these two metrics. Users are also able to select what crime type is displayed on the graph for further cross comparison to see how the temporal and reporting trends of crime types differ from one another."),
